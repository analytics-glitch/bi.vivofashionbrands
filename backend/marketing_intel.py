...
def suggested_action(sor_pct: float, stock: float) -> str:
    ...
    if sor_pct < 20:
        return "Consider store transfer to higher-traffic location"
    ...
    *,
    ...
    for r in sales_rows or []:
        ...
        out.append({
            ...
            "suggested_action": suggested_action(sor, stock),
        })
    ...
    for style, inv in inventory_by_style.items():
        ...
        out.append({
            ...
            "suggested_action": suggested_action(0.0, stock),
        })
