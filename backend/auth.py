...
_VIEWER = ["overview", "locations", "footfall", "customers", "customer-details", "feedback", "morning-brief"]
...
_ANALYST = _VIEWER + ["inventory", "re-order", "ibt", "products", "pricing", "data-quality", "allocations", "replenishments", "marketing"]
